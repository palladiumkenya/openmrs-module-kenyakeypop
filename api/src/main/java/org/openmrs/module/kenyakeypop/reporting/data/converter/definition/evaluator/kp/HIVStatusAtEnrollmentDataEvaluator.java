...
import org.openmrs.module.kenyakeypop.reporting.data.converter.definition.kp.HIVStatusAtEnrollmentDataDefinition;
 ...
 */
@Handler(supports = HIVStatusAtEnrollmentDataDefinition.class, order = 50)
public class HIVStatusAtEnrollmentDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select e.client_id,coalesce((case e.share_test_results when \"Yes I tested positive\" then \"Known Positive\" else \"U\" end ),(case t.final_test_result when \"Positive\" then \"P\" when \"Negative\" then \"N\" else \"U\" end)) as hiv_status_at_enrollment\n"
		        ...
		        + "on (t.client_id = e.client_id and t.visit_date = e.visit_date) group by e.client_id;";
