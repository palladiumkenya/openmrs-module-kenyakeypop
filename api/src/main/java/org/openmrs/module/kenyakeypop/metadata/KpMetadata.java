...
public class KpMetadata extends AbstractMetadataBundle {
	...
	@Override
	public void install() {
		install(encounterType("KP Enrollment", "Handles KP kpClient enrollment",
		    KpMetadata._EncounterType.KP_CLIENT_ENROLLMENT));
		install(encounterType("KP Discontinuation", "Records information about KP kpClient discontinuation",
		...
		install(patientIdentifierType("KP unique Number", "Unique Number assigned to KP kpClient upon enrollment", null,
