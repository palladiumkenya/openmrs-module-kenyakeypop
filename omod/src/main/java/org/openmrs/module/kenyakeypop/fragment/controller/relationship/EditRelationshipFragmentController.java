 ...
 */
package org.openmrs.module.kenyakeypop.fragment.controller.relationship;
...
public class EditRelationshipFragmentController {
	...
	public void controller(@FragmentParam(value = "relationship", required = false) Relationship relationship,
	        @FragmentParam("returnUrl") String returnUrl, PageModel model) {
	...
	public Object saveRelationship(@MethodParam("getEditRelationshipForm") @BindParams EditRelationshipForm form, UiUtils ui) {
