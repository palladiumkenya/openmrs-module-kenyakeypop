 ...
 */
package org.openmrs.module.kenyakeypop.fragment.controller.program;
...
public class ProgramCarePanelsFragmentController {
	...
	public void controller(FragmentModel model, @FragmentParam("kpClient") Patient patient,
	        @FragmentParam("complete") boolean complete, @FragmentParam("activeOnly") boolean activeOnly,
	        @SpringBean ProgramManager programManager) {
		
		List<UiResource> carePanels = new ArrayList<UiResource>();
		
		Collection<ProgramDescriptor> programs = activeOnly ? programManager.getPatientActivePrograms(patient)
