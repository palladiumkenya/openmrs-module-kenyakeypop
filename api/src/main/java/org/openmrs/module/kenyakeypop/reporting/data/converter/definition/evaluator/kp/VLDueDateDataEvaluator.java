...
import org.openmrs.module.kenyakeypop.reporting.data.converter.definition.kp.VLDueDateDataDefinition;
...
public class VLDueDateDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select v.client_id,(case v.eligible_vl when 'Yes' then 'Y' when 'No' then 'N' else '' end) as due_for_vl from kenyaemr_etl.etl_clinical_visit v group by v.client_id;";
