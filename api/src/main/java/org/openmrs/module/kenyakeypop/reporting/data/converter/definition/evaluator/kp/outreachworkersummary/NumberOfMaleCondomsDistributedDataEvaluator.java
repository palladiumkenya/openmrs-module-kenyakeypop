...
public class NumberOfMaleCondomsDistributedDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select r.person_a as peer_educator,sum(p.monthly_male_condoms_distributed) as condoms_distributed from openmrs.relationship r inner join kenyaemr_etl.etl_peer_calendar p on r.person_b= p.client_id where r.voided = 0\n"
