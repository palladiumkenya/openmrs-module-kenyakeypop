...
public class NumberOfMaleCondomsDistributedDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select r.person_a as peer_educator,(sum(a.monthly_male_condoms_distributed)+b.monthly_male_condoms_distributed) as monthly_male_condoms_distributed from relationship r\n"
		        + "inner join (select pc.client_id,IFNULL(pc.monthly_male_condoms_distributed,0) as monthly_male_condoms_distributed from kenyaemr_etl.etl_peer_calendar pc GROUP BY pc.client_id) a\n"
		        + "on r.person_b = a.client_id\n"
		        + "inner join (select pc.client_id,IFNULL(pc.monthly_male_condoms_distributed,0) as monthly_male_condoms_distributed from kenyaemr_etl.etl_peer_calendar pc GROUP BY pc.client_id) b\n"
