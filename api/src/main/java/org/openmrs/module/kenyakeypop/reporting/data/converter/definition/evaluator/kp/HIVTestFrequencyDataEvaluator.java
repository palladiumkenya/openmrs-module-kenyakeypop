 ...
 */
@Handler(supports = HIVTestFrequencyDataDefinition.class, order = 50)
public class HIVTestFrequencyDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select v.client_id, v.test_frequency from kenyaemr_etl.etl_clinical_visit v group by v.client_id having max(v.visit_date);";
