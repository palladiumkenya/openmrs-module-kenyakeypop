...
/**
 * Returns a list of programs a patient is enrolled and the dates of enrollment Where there is more
 * than one program and HIV is part, date enrolled in hiv takes precedence
 */
