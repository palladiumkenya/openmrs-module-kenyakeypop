        ...
        <div class="dashboard clear">
            <div class="info-container column">
                ...
                <div class="info-section">
                    ...
                    ${ ui.includeFragment("kenyaemr", "kpClient/patientRelationships", [patient: currentPatient]) }
            ...
            <div class="info-container column">
                ...
                <div class="info-section">
                    ...
                    <div class="info-body">
                        ${ ui.includeFragment("kenyaemr", "kpClient/recentVisits", [ patient: currentPatient, showClinicalData: true ]) }
                    </div>
                </div>
                ...
                <div class="info-section allergies">
                    ...
                    <div class="info-body">
                        ${ ui.includeFragment("kenyaemr", "kpClient/currentVitals", [ patient: currentPatient]) }
                    </div>
                </div>
            </div>

            ${ ui.includeFragment("kenyaemr", "kpClient/actionsPanel", [visit: visit]) }
