...
public class MonthlyReportCohortLibrary {
    ...
    public CohortDefinition contactHCW(String kpType) {
        ...
        String sqlQuery = "select c.client_id from kenyaemr_etl.etl_contact c join kenyaemr_etl.etl_client_enrollment e on c.client_id = e.client_id and e.voided = 0\n" +
                ...
                "where (v.client_id is not null or p.client_id is not null ) and c.voided = 0 and c.key_population_type= '"+kpType+"' group by c.client_id;";
	...
	public CohortDefinition kpPrev(String kpType) {
		...
		String sqlQuery = "select c.client_id from kenyaemr_etl.etl_contact c\n" +
                ...
                "date(case MONTH(:startDate) when 1 then replace('0000-10-01','0000',(YEAR(date_sub(:startDate, INTERVAL 1 YEAR)))) when 2 then replace('0000-10-01','0000',(YEAR(date_sub(:startDate, INTERVAL 1 YEAR))))\n" +
                "when 3 then replace('0000-10-01','0000',(YEAR(date_sub(:startDate, INTERVAL 1 YEAR)))) when 4 then replace"+startOfYear+",'0000',(YEAR(date_sub(:startDate, INTERVAL 1 YEAR))))\n" +
                ...
                "when 11 then replace"+startOfYear+",'0000',YEAR(:startDate)) when 12 then replace"+startOfYear+",'0000',YEAR(:startDate)) else null end) and date(:endDate)))\n" +
                "or (v.first_clinical_visit_date between (case MONTH(:startDate) when 1 then replace"+startOfYear+",'0000',(YEAR(date_sub(:startDate, INTERVAL 1 YEAR)))) when 2 then replace"+startOfYear+",'0000',(YEAR(date_sub(:startDate, INTERVAL 1 YEAR))))\n" +
                ...
                " when 9 then replace"+startOfYear+",'0000',(YEAR(date_sub(:startDate, INTERVAL 1 YEAR)))) when 10 then replace"+startOfYear+",'0000',YEAR(:startDate))\n" +
                " when 11 then replace"+startOfYear+",'0000',YEAR(:startDate)) when 12 then replace"+startOfYear+",'0000',YEAR(:startDate)) else null end) and date(:endDate))\n" +
                "or (p.first_peer_enc between (case MONTH(:startDate) when 1 then replace"+startOfYear+",'0000',(YEAR(date_sub(:startDate, INTERVAL 1 YEAR)))) when 2 then replace"+startOfYear+",'0000',(YEAR(date_sub(:startDate, INTERVAL 1 YEAR))))\n" +
                " when 3 then replace"+startOfYear+",'0000',(YEAR(date_sub(:startDate, INTERVAL 1 YEAR)))) when 4 then replace"+startOfYear+",'0000',(YEAR(date_sub(:startDate, INTERVAL 1 YEAR))))\n" +
                " when 5 then replace"+startOfYear+",'0000',(YEAR(date_sub(:startDate, INTERVAL 1 YEAR)))) when 6 then replace"+startOfYear+",'0000',(YEAR(date_sub(:startDate, INTERVAL 1 YEAR))))\n" +
                " when 7 then replace"+startOfYear+",'0000',(YEAR(date_sub(:startDate, INTERVAL 1 YEAR)))) when 8 then replace"+startOfYear+",'0000',(YEAR(date_sub(:startDate, INTERVAL 1 YEAR))))\n" +
                " when 9 then replace"+startOfYear+",'0000',(YEAR(date_sub(:startDate, INTERVAL 1 YEAR)))) when 10 then replace"+startOfYear+",'0000',YEAR(:startDate))\n" +
                " when 11 then replace"+startOfYear+",'0000',YEAR(:startDate)) when 12 then replace"+startOfYear+",'0000',YEAR(:startDate)) else null end) and date(:endDate))) and c.key_population_type= '"+kpType+"' and c.voided=0)\n" +
    ...
    public CohortDefinition txPvlsEligibleDice(String kpType) {
        ...
        String sqlQuery = "select client_id\n" +
                ...
                "on d.patient_id = e.client_id and ifnull(d.voided, 0) = 0 where e.key_population_type = '"+kpType+"' and e.voided = 0\n" +
...
String sqlQuery = "select client_id\n" +
    ...
    public CohortDefinition txPvlsEligibleVerifyPEPFAR(String kpType) {
        ...
        String sqlQuery = "select client_id\n" +
                ...
                "where e.key_population_type = '"+kpType+"' and e.voided = 0\n" +
                "group by e.client_id) a\n" +
