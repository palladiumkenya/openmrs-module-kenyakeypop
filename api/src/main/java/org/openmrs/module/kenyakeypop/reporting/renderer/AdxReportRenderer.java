 ...
 */
package org.openmrs.module.kenyakeypop.reporting.renderer;
...
public class AdxReportRenderer extends ReportDesignRenderer {
	...
	public void render(ReportData reportData, String argument, OutputStream out) throws IOException, RenderingException {
		...
		w.write("<adx xmlns=\"urn:ihe:qrph:adx:2015\"\n" + "xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"\n"
		        ...
		        + isoDateTimeFormat.format(new Date()) + "\">\n");
		
		for (String dsKey : reportData.getDataSets().keySet()) {
			w.write("<group orgUnit=\"" + mfl + "\" period=\"" + isoDateFormat.format(reportDate) + "/P1M\" dataSet=\""
			        + reportData.getDefinition().getName().replace(" ", "_") + "-" + dsKey + "\">\n");
