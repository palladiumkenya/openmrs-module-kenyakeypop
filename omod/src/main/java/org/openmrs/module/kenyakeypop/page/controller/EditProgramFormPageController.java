...
public class EditProgramFormPageController {
	...
	public String controller(@RequestParam("appId") String appId,
		...
		StringBuilder sb = new StringBuilder("redirect:" + KpConstant.MODULE_ID + "/");
		...
		List<Encounter> encounters = Context.getEncounterService().getEncounters(patient, null,
		    enrollment.getDateEnrolled(), enrollment.getDateCompleted(), Collections.singleton(form), null, null, null,
		    null, false);
