...
public class KpMetadata extends AbstractMetadataBundle {
	...
	public void install() {
		...
		install(encounterType("KP Abscess screening", "Handles KP Abscess screening",
		    KpMetadata._EncounterType.KP_ABSCESS_SCREENING));
		...
		install(encounterType("KP Chronic Illness Screening", "Handles KP Chronic Illness",
		    KpMetadata._EncounterType.KP_CHRONIC_ILLNESS));
		...
		install(encounterType("KP Current medication", "Handles KP current medication",
		    KpMetadata._EncounterType.KP_CURRENT_MEDICATION));
		...
		install(encounterType("KP Adverse drug reactions", "Handles KP Adverse drug reactions",
		    KpMetadata._EncounterType.KP_DRUG_REACTIONS));
		install(encounterType("KP Hepatitis screening", "Handles KP Hepatits B screening",
		    KpMetadata._EncounterType.KP_HEPATITIS_SCREENING));
		install(encounterType("KP Immunization screening", "Handles KP Immunization screening",
		    KpMetadata._EncounterType.KP_IMMUNIZATION_SCREENING));
		install(encounterType("KP Allergies screening", "Handles KP Allergies screening",
		    KpMetadata._EncounterType.KP_ALLERGIES_SCREENING));
		install(encounterType("KP Counselling services", "Handles KP Counselling Services",
		    KpMetadata._EncounterType.KP_COUNSELLING_SERVICES));
		...
		install(encounterType("KP Prophylaxis screening", "Handles KP Prophylaxis screening",
		    KpMetadata._EncounterType.KP_PREP_PEP_SCREENING));
		install(encounterType("KP Pregnancy and FP screening", "Handles KP Pregnancy and FP screening",
		    KpMetadata._EncounterType.KP_PREGNANCY_AND_FP_SCREENING));
		install(encounterType("KP Risk reduction screening", "Handles KP Risk reduction screening",
		    KpMetadata._EncounterType.KP_RISK_REDUCION_SCREENING));
		...
		install(encounterType("KP Systems examinations", "Handles KP systems examination",
		    KpMetadata._EncounterType.KP_SYSTEMS_EXAMINATION));
		install(encounterType("KP Violence screening", "Handles KP violence screening",
		    KpMetadata._EncounterType.KP_VIOLENCE_SCREENING));
		install(encounterType("KP Alcohol,drugs and risk reduction screening",
		    "Handles KP alcohol,drugs and risk reduction screening", KpMetadata._EncounterType.KP_PSYCHOSOCIAL_SCREENING));
		...
		install(encounterType("KP Peer Overdose reporting", "Handles KP Peer Overdose reporting",
		...
		install(encounterType("KP Health Education", "Handles KP Health Education",
		    KpMetadata._EncounterType.KP_HEALTH_EDUCATION));
		...
		install(form("HIV Status", null, KpMetadata._EncounterType.KP_CLIENT_HIV_STATUS, "1",
		    KpMetadata._Form.KP_CLIENT_HIV_STATUS_FORM));
		
		install(form("Abscess Screening", null, KpMetadata._EncounterType.KP_ABSCESS_SCREENING, "1",
		    KpMetadata._Form.KP_ABSCESS_SCREENING_FORM));
		...
		install(form("Chronic Illness", null, KpMetadata._EncounterType.KP_CHRONIC_ILLNESS, "1",
		    KpMetadata._Form.KP_CHRONIC_ILLNESS_FORM));
		install(form("Clinical Notes", null, KpMetadata._EncounterType.KP_CLINICAL_NOTES, "1",
		    KpMetadata._Form.KP_CLINICAL_NOTES_FORM));
		install(form("Complaints", null, KpMetadata._EncounterType.KP_COMPLAINTS, "1", KpMetadata._Form.KP_COMPLAINTS_FORM));
		install(form("Current Medication Form", null, KpMetadata._EncounterType.KP_CURRENT_MEDICATION, "1",
		    KpMetadata._Form.KP_CURRENT_MEDICATION_FORM));
		...
		install(form("Adverse Drug Reactions", null, KpMetadata._EncounterType.KP_DRUG_REACTIONS, "1",
		    KpMetadata._Form.KP_DRUG_REACTIONS_FORM));
		install(form("Hepatitis Screening", null, KpMetadata._EncounterType.KP_HEPATITIS_SCREENING, "1",
		    KpMetadata._Form.KP_HEPATITIS_SCREENING_FORM));
		install(form("Immunization Screening", null, KpMetadata._EncounterType.KP_IMMUNIZATION_SCREENING, "1",
		    KpMetadata._Form.KP_IMMUNIZATION_SCREENING_FORM));
		install(form("Allergies Screening", null, KpMetadata._EncounterType.KP_ALLERGIES_SCREENING, "1",
		    KpMetadata._Form.KP_ALLERGIES_SCREENING_FORM));
		install(form("Counselling Services", null, KpMetadata._EncounterType.KP_COUNSELLING_SERVICES, "1",
		    KpMetadata._Form.KP_COUNSELLING_SERVICES_FORM));
		...
		install(form("Prep/Pep Services", null, KpMetadata._EncounterType.KP_PREP_PEP_SCREENING, "1",
		    KpMetadata._Form.KP_PREP_PEP_SCREENING_FORM));
		install(form("Pregnancy, FP and CaCx Screening", null, KpMetadata._EncounterType.KP_PREGNANCY_AND_FP_SCREENING, "1",
		    KpMetadata._Form.KP_PREGNANCY_AND_FP_SCREENING_FORM));
		install(form("Risk Reduction Screening", null, KpMetadata._EncounterType.KP_RISK_REDUCION_SCREENING, "1",
		    KpMetadata._Form.KP_RISK_REDUCION_SCREENING_FORM));
		install(form("STI Screening", null, KpMetadata._EncounterType.KP_STI_TREATMENT, "1",
		    KpMetadata._Form.KP_STI_SCREENING_FORM));
		...
		install(form("TB screening", null, KpMetadata._EncounterType.KP_TB_SCREENING, "1",
		    KpMetadata._Form.KP_TB_SCREENING_FORM));
		install(form("Review of Body systems", null, KpMetadata._EncounterType.KP_SYSTEMS_EXAMINATION, "1",
		    KpMetadata._Form.KP_SYSTEMS_EXAMINATION_FORM));
		...
		install(form("Alcohol, Drugs and Risk Reduction Screening", null,
		    KpMetadata._EncounterType.KP_PSYCHOSOCIAL_SCREENING, "1", KpMetadata._Form.KP_PSYCHOSOCIAL_SCREENING_FORM));
		...
		install(form("Peer Education", "Form for adding Health education", KpMetadata._EncounterType.KP_HEALTH_EDUCATION,
		    "1", KpMetadata._Form.KP_HEALTH_EDUCATION_FORM));
