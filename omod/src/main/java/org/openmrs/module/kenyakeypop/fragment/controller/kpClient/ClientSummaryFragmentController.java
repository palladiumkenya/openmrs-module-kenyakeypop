...
public class ClientSummaryFragmentController {
	...
	public void controller(@FragmentParam("kpClient") Patient patient, @SpringBean FormManager formManager,
		...
		// Get all common per-kpClient forms as simple objects
	...
	/**
	 * Checks if a kpClient has been recorded as deceased by a program
	 * 
	 * @param patient the kpClient
	 * @return true if kpClient was recorded as deceased
	 */
