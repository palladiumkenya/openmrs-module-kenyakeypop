...
public class ETLMoh731PlusIndicatorLibrary {
	...
	public CohortIndicator activeFsw() {
		return cohortIndicator("",
		    ReportUtils.map(moh731BCohorts.activeFsw(), "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator activeMsm() {
		return cohortIndicator("",
		    ReportUtils.map(moh731BCohorts.activeMsm(), "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator activeMsw() {
		return cohortIndicator("",
		    ReportUtils.map(moh731BCohorts.activeMsw(), "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator activePwid() {
		return cohortIndicator("",
		    ReportUtils.map(moh731BCohorts.activePwid(), "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator activePwud() {
		return cohortIndicator("",
		    ReportUtils.map(moh731BCohorts.activePwud(), "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator activeTransgender() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.activeTransgender(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator activePrisonersAndClossedSettings() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.activePrisonersAndClossedSettings(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator hivTestedFsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.hivTestedFsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator hivTestedMsm() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.hivTestedMsm(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator hivTestedMsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.hivTestedMsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator hivTestedPwid() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.hivTestedPwid(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator hivTestedPwud() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.hivTestedPwud(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator hivTestedTransgender() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.hivTestedTransgender(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator hivTestedPrisonersAndClosedSettings() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.hivTestedPrisonersAndClosedSettings(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedAtFacilityFsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtFacilityFsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedAtFacilityMsm() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtFacilityMsm(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedAtFacilityMsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtFacilityMsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedAtFacilityPwid() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtFacilityPwid(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedAtFacilityPwud() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtFacilityPwud(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedAtFacilityTransgender() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtFacilityTransgender(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedAtFacilityPrisonersClosedSettings() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtFacilityPrisonersClosedSettings(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedAtCommunityFsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtCommunityFsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedAtCommunityMsm() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtCommunityMsm(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedAtCommunityMsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtCommunityMsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedAtCommunityPwid() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtCommunityPwid(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedAtCommunityPwud() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtCommunityPwud(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedAtCommunityTransgender() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtCommunityTransgender(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedAtCommunityPrisonersClosedSettings() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtCommunityPrisonersClosedSettings(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedNewFsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedNewFsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedNewMsm() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedNewMsm(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedNewMsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedNewMsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedNewPwid() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedNewPwid(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedNewPwud() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedNewPwud(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedAtNewTransgender() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtNewTransgender(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator newlyTestedprisonersClosedSettings() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.newlyTestedprisonersClosedSettings(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedRepeatFsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedRepeatFsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedRepeatMsm() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedRepeatMsm(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedRepeatMsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedRepeatMsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedRepeatPwid() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedRepeatPwid(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedRepeatPwud() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedRepeatPwud(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedRepeatTransgender() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedRepeatTransgender(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator testedRepeatPrisonersAndClosedSettings() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedRepeatPrisonersAndClosedSettings(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator selfTestedForHIVFsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.selfTestedForHIVFsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator selfTestedForHIVMsm() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.selfTestedForHIVMsm(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator selfTestedForHIVMsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.selfTestedForHIVMsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator selfTestedForHIVPwid() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.selfTestedForHIVPwid(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator selfTestedForHIVPwud() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.selfTestedForHIVPwud(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator selfTestedForHIVTransgender() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.selfTestedForHIVTransgender(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator selfTestedForHIVPrisonersAndClosedSettings() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.selfTestedForHIVPrisonersAndClosedSettings(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator knownPositiveFsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.knownPositiveFsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator knownPositiveMsm() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.knownPositiveMsm(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator knownPositiveMsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.knownPositiveMsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator knownPositivePwid() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.knownPositivePwid(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator knownPositivePwud() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.knownPositivePwud(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator knownPositiveTransgender() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.knownPositiveTransgender(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator knownPositivePrisonersClosedSettings() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.knownPositivePrisonersClosedSettings(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivedPositiveResultsFsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivedPositiveResultsFsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivedPositiveResultsMsm() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivedPositiveResultsMsm(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivedPositiveResultsMsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivedPositiveResultsMsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivedPositiveResultsPwid() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivedPositiveResultsPwid(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivedPositiveResultsPwud() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivedPositiveResultsPwud(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	...
	public CohortIndicator receivedPositiveResultsPrisonersClosedSettings() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivedPositiveResultsPrisonersClosedSettings(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator linkedFsw() {
		return cohortIndicator("",
		    ReportUtils.map(moh731BCohorts.linkedFsw(), "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator linkedMsm() {
		return cohortIndicator("",
		    ReportUtils.map(moh731BCohorts.linkedMsm(), "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator linkedMsw() {
		return cohortIndicator("",
		    ReportUtils.map(moh731BCohorts.linkedMsw(), "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator linkedPwid() {
		return cohortIndicator("",
		    ReportUtils.map(moh731BCohorts.linkedPwid(), "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator linkedPwud() {
		return cohortIndicator("",
		    ReportUtils.map(moh731BCohorts.linkedPwud(), "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator linkedTransgender() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.linkedTransgender(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator linkedPrisonersClosedSettings() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.linkedPrisonersClosedSettings(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingCondomsFsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsFsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingCondomsMsm() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsMsm(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingCondomsMsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsMsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingCondomsPwid() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsPwid(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingCondomsPwud() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsPwud(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingCondomsTransgender() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsTransgender(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}

	public CohortIndicator receivingCondomsPrisonersClosedSettings() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsPrisonersClosedSettings(),
				"startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingCondomsPerNeedPerNeedFsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsPerNeedPerNeedFsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingCondomsPerNeedMsm() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsPerNeedMsm(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingCondomsPerNeedMsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsPerNeedMsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingCondomsPerNeedPwid() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsPerNeedPwid(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingCondomsPerNeedPwud() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsPerNeedPwud(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	...
	public CohortIndicator receivingCondomsPerNeedPrisonersClosedSettings() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsPerNeedPrisonersClosedSettings(),
				"startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingNeedlesAndSyringesFsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingNeedlesAndSyringesFsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingNeedlesAndSyringesMsm() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingNeedlesAndSyringesMsm(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingNeedlesAndSyringesMsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingNeedlesAndSyringesMsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingNeedlesAndSyringesPwid() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingNeedlesAndSyringesPwid(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingNeedlesAndSyringesPwud() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingNeedlesAndSyringesPwud(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	...
	public CohortIndicator receivingLubricantsFsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingLubricantsFsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingLubricantsMsm() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingLubricantsMsm(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingLubricantsMsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingLubricantsMsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingLubricantsPwid() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingLubricantsPwid(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingLubricantsPwud() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingLubricantsPwud(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingLubricantsTransgender() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingLubricantsTransgender(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingLubricantsPerNeedFsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingLubricantsPerNeedFsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingLubricantsPerNeedMsm() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingLubricantsPerNeedMsm(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingLubricantsPerNeedMsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingLubricantsPerNeedMsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingLubricantsPerNeedPwid() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingLubricantsPerNeedPwid(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator receivingLubricantsPerNeedPwud() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingLubricantsPerNeedPwud(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	...
	public CohortIndicator screenedForSTIFsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedForSTIFsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator screenedForSTIMsm() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedForSTIMsm(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator screenedForSTIMsw() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedForSTIMsw(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator screenedForSTIPwid() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedForSTIPwid(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator screenedForSTIPwud() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedForSTIPwud(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	
	public CohortIndicator screenedForSTITransgender() {
		return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedForSTITransgender(),
		    "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	}
	...
	/* public CohortIndicator completedPEPWith28DaysFsw() {
	     return cohortIndicator("", ReportUtils.map(moh731BCohorts.completedPEPWith28DaysFsw(), "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	 }

	 public CohortIndicator completedPEPWith28DaysMsm() {
	     return cohortIndicator("", ReportUtils.map(moh731BCohorts.completedPEPWith28DaysMsm(), "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	 }
	 public CohortIndicator completedPEPWith28DaysMsw() {
	     return cohortIndicator("", ReportUtils.map(moh731BCohorts.completedPEPWith28DaysMsw(), "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	 }
	 public CohortIndicator completedPEPWith28DaysPwid() {
	     return cohortIndicator("", ReportUtils.map(moh731BCohorts.completedPEPWith28DaysPwid(), "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	 }

	 public CohortIndicator completedPEPWith28DaysPwud() {
	     return cohortIndicator("", ReportUtils.map(moh731BCohorts.completedPEPWith28DaysPwud(), "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	 }
	 public CohortIndicator completedPEPWith28DaysTransgender() {
	     return cohortIndicator("", ReportUtils.map(moh731BCohorts.completedPEPWith28DaysTransgender(), "startDate=${startDate},endDate=${endDate},subCounty=${subCounty}"));
	 }*/
}
