...
public class CondomDistributedDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select c.client_id as client_id ,coalesce(c.monthly_male_condoms_distributed,0) + coalesce(c.monthly_female_condoms_distributed,0) as monthly_condoms_distributed from kenyaemr_etl.etl_peer_calendar c\n"
