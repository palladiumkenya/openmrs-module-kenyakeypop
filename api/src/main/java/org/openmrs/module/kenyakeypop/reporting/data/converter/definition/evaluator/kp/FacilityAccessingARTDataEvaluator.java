...
public class FacilityAccessingARTDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select v.patient_id,mid(max(concat(v.visit_date,v.facility_transferred_from)),11) as facility_transferred_from  from kenyaemr_etl.etl_hiv_enrollment v\n"
