 ...
 */
@Handler(supports = SubCountyOfImplementationDataDefinition.class, order = 50)
public class SubCountyOfImplementationDataDefinitioEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select client_id, implementation_subcounty from kenyaemr_etl.etl_contact;";
