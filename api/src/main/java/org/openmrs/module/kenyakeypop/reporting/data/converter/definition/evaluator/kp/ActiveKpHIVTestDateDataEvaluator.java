 ...
 */
@Handler(supports = ActiveKpHIVTestDateDataDefinition.class, order = 50)
public class ActiveKpHIVTestDateDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select c.client_id,coalesce(v.visit_date,t.visit_date) as hiv_test_date\n"
		        + "from kenyaemr_etl.etl_contact c\n"
		        + "  left outer join kenyaemr_etl.etl_clinical_visit v on v.client_id = c.client_id and v.test_results in ('Positive','Negative') and v.visit_date between date_sub(date(curdate()), INTERVAL 3 MONTH ) and date(curdate())\n"
