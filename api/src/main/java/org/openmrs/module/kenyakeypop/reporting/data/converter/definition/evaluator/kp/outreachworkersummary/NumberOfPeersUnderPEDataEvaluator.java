...
import org.openmrs.module.kenyakeypop.reporting.data.converter.definition.outreachworkersummary.NumberOfPeersUnderPEDataDefinition;
...
public class NumberOfPeersUnderPEDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select r.person_a as peer_educator,count(a.client_id) from relationship r\n"
		        + "inner join (select pc.client_id from kenyaemr_etl.etl_kp_peer_calendar pc group by pc.client_id) a on r.person_b = a.client_id\n"
