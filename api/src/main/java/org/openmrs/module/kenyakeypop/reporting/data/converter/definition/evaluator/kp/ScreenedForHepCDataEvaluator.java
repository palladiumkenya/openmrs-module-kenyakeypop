...
public class ScreenedForHepCDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select v.client_id,v.hepatitisC_screened from kenyaemr_etl.etl_clinical_visit where date(v.visit_date) between date(:startDate) and date(:endDate);";
