...
import org.openmrs.module.kenyakeypop.reporting.data.converter.definition.kp.VLDoneDataDefinition;
...
public class VLDoneDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select v.client_id,(case mid(max(concat(v.visit_date,v.vl_test_done)),11) when 'Y' then 'Y' when 'N' then 'N' else '' end) as vl_done\n"
